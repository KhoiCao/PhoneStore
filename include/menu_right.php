<?php 
					if(isset($_SESSION['username'])){
						...
						<div>
							...
							<tr style="height: 40px;"><td id="tieudedangnhap" style="color: #000099;font-size: 18px;font-weight: bold;text-align: center;">
							Đăng nhập</td></tr>
							<tr><td><span id="xinchao"><p>Xin chào: <span style="color: #ff0000;text-align: center;"> 
								<?php if($_SESSION['phanquyen'] == 0) :?> <a href = "admin/admin.php"><?php echo ($_SESSION['username'])?></a><?php else :?> <?php echo ($_SESSION['username']) ?> 
								<?php endif; ?>  </span></p></span></td></tr>
							</table>
						</div>
					<?php } 
					else {?>
				 ...
				 <div id="gio_hang">
					<div class="center1">
						<h4>GIỎ HÀNG</h4>
							<a href="index.php?content=cart"><img src="images/cart.png" title="Vào giỏ hàng" width="150" height="100px"></a>
							<?php 
								$tongtien=0;

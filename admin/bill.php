...
<div class="quanlysp">
	...
	<form action="admin.php?admin=billhandling" method="post">
		<div id="check">
			<p>
...
?>
            <tr class='noidung_hienthi_sp'>
				...
				<td class="active_hienthi_sp" style="width:70px;"><a href="admin.php?admin=billdetail&mahd=<?php echo $bien['mahd']; ?> " style="float:left;">Chi tiết</a>
...
?>
	...
	<?php
			...
			if($page > 1){  
			$prev = ($page - 1);  
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=viewbill&page=$prev\"><button class='trang'>Trang trước</button></a>&nbsp;";  
			}  
			...
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=viewbill&page=$i\"><button class='so'>$i</button></a>&nbsp;";  
			}  
			}  
			...
			if($page < $total_pages){  
			$next = ($page + 1);  
			echo "<a href=\"".$_SERVER['PHP_SELF']."?admin=viewbill&page=$next\"><button class='trang'>Trang sau</button></a>";  
			}  
			echo "</center>";  		

...
elseif(isset($_GET['madm'])) {
    ...
    if(!isset($_GET['page'])){
        ...
        // Chọn số kết quả trả về trong mỗi trang mặc định là 12
    $max_results = 12;
                ...
                while ($result=mysqli_fetch_assoc($query))
                    { ?>
                        ...
                        <div class="dienthoai">
                            ...
                            <?php } ?>
                            <a href="#"><img  src="images/uploads/<?php echo $result['hinhanh'];?>"></a>
    ...
    // Tính tổng kết quả trong toàn DB:
                        $total_results = mysqli_result(mysqli_query($conn,"SELECT COUNT(*) as Num FROM sanpham where madm='{$_GET['madm']}'"),0,0);
                            ...
                            while ($row=mysqli_fetch_assoc($result1))
                                { ?>
                                    ...
                                    <div class="dienthoai">
                                        ...
                                        <?php } ?>
                                        <h1><a href="#"><img  src="images/uploads/<?php echo $row['hinhanh'];?>"></a></h1>
